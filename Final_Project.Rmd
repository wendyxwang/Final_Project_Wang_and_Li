...
- Batch effects check
```{r batch,echo=FALSE,fig.width=15,fig.height=8}
batch.m<-ma$M
...
rownames(Table)<-c("proportion(p-value<.05)","proportion(bonferroni<.05)")
...
- Paired t-test comparing treatment and placebo
*plots*
*The therethod value for q value and bonferroni test cut is 0.001.
```{r Qvalueplot,echo=FALSE}
...
- GSEA analysis using Wilcoxon Test
....
```{r GSEA-wilcoxon test,echo=FALSE}
